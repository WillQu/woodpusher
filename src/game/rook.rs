...
pub fn list_rook_moves(game: &Game, position: Position, player: Player) -> Vector<Move<'_>> {
...
mod tests {
    ...
    fn from_h8() {
        ...
        //Then
        let expected: HashSet<Position> = vector![
            "h7", "h6", "h5", "h4", "h3", "h2", "h1", "a8", "b8", "c8", "d8", "e8", "f8", "g8"
        ]
        .iter()
        .map(|pos| Position::from(pos).unwrap())
        .collect();
    ...
    fn friend_in_the_way() {
        ...
        let board = Board::empty()
            ...
            .put(
                ...
                Piece::new(PieceType::Pawn, White),
            );
    ...
    fn enemy_in_the_way() {
        ...
        let board = Board::empty()
            ...
            .put(
                Position::from("a2").unwrap(),
                Piece::new(PieceType::Pawn, Black),
            );
        let game = Game::from_board(board, White);
